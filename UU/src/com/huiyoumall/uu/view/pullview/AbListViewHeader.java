package com.huiyoumall.uu.view.pullview;
...
import com.huiyoumall.uu.util.AbViewUtil;
...
public class AbListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		// 从包里获取的箭头图片
		// arrowImage = ImageUtils.getBitmapFromSrc("image/arrow.png");
		// arrowImageView.setImageBitmap(arrowImage);
		arrowImageView.setBackground(mContext.getResources().getDrawable(
				R.drawable.listview_arrow));
